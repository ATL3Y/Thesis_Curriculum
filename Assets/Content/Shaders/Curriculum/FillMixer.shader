...
Shader "Custom/FillMixer" 
{
	Properties{
		_UnfilledColor( "Unfilled Color", Color ) = ( 1.0, 0.0, 0.0, 1.0 )
		_FilledColor( "Filled Color", Color ) = ( 0.0, 0.7, 0.7, 1.0 )
	...
	SubShader
		...
		Pass
		{
			...
			float4 frag(vertexOutput o):COLOR
			{
				...
				if (uv.y < _FillAmount)
				{
					finalColor = _FilledColor;
				}
				else
				{
					finalColor = _UnfilledColor;
				}
